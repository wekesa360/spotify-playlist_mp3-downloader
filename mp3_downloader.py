...
class PlaylistDownloader:
    ...
    def display_playlist_tracks(self):
        ...
        with fpath.open(mode='r') as csv_file:
            ...
            tracks = [f"{row['name']} - {row['artists']}: spotify_url: {row['spotify_url']}" for row in csv_reader]
    ...
    def find_and_download_songs(self):
        ...
        with fpath.open(mode="r", encoding='utf-8') as file:
            ...
            for row in csv_reader:
                ...
                downloaded_file_path = check_song_in_downloads(filename, self.downloads_path)
